...
class B_activity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            CameraFeaturesScreenB(locationEngineResult)
        }
    }
...
@Composable
fun CameraFeaturesScreenB(locationEngineResult: LocationEngineCallback<LocationEngineResult>) {
            ...
            MapplsMap(
                ...
                onSuccess = { mapView, mapplsMap ->
                    ...
                    if (LocationUtils.locationComponent != null) {
                        ...
                        Toast.makeText(context, "NAVIGATING TO B-BLOCK", Toast.LENGTH_SHORT).show()
                    }
