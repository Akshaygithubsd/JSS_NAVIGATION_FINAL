...
class Jeweleery : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            CameraFeaturesScreenJ(locationEngineResult)
        }
    }
...
@Composable
fun CameraFeaturesScreenJ(locationEngineResult: LocationEngineCallback<LocationEngineResult>) {
    ...
    Scaffold(topBar = {
            ...
            MapplsMap(
                ...
                onSuccess = { mapView, mapplsMap ->
                    ...
                    if (LocationUtils.locationComponent != null) {
                        ...
                        Toast.makeText(context, "NAVIGATING TO JEWELLERY-BLOCK", Toast.LENGTH_SHORT).show()
                    }
        ...
        LaunchedEffect(mapplsMapState.value, locationState.value) {
            ...
            if (mapplsMap != null) {
                ...
                openGoogleMaps(context, LocationUtils.globallatitude, LocationUtils.globallongitude, 12.902504259595233, 77.50514509157726)
